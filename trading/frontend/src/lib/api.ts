...
export interface TraderAlertsResponse {
  alerts: AlertItem[];
  count: number;
  ts: string;
  error?: string;
...
// ============= AI Berkshire research desk =============

export type BerkshireLaneKey = "crypto" | "forex";
export type BerkshireTone = "success" | "warning" | "info" | "danger" | "neutral" | "accent";
export type BerkshireSkill =
  | "investment-team"
  | "investment-research"
...
export interface BerkshireLane {
  key: BerkshireLaneKey;
  label: string;
  status: string;
  status_label: string;
  subtitle: string;
  ...
  instruments: string[];
  blockers: string[];
  telemetry: Array<{ label: string; value: string; tone: BerkshireTone }>;
}

export interface BerkshirePipelineStep {
  title: string;
  owner: string;
  status: string;
  tone: BerkshireTone;
...
export interface BerkshireAnalystPod {
  label: string;
  value: string;
  detail: string;
}

export interface BerkshireRunAnalyst {
  key: string;
  name: string;
  focus: string;
  question: string;
...
export interface BerkshireChecklistItem {
  label: string;
  status: string;
  tone: BerkshireTone;
  detail: string;
...
export interface BerkshireFinancialChecks {
  status: string;
  tone: BerkshireTone;
  summary: string;
  direction?: string;
  ...
  items: Array<{ label: string; value: string; tone: BerkshireTone }>;
}

export interface BerkshireResearchRun {
  id: string;
  created_at: string;
  lane: BerkshireLaneKey;
  symbol: string;
  ...
  catalyst: string;
  thesis: string;
  analysts: BerkshireRunAnalyst[];
  checklist: BerkshireChecklistItem[];
  financial_checks: BerkshireFinancialChecks;
...
export interface BerkshireState {
  ...
  lanes: BerkshireLane[];
  pipelines: Record<BerkshireLaneKey, BerkshirePipelineStep[]>;
  analyst_pods: BerkshireAnalystPod[];
...
export interface BerkshireResearchRequest {
  lane: BerkshireLaneKey;
  symbol: string;
  skill: BerkshireSkill;
  catalyst?: string;
