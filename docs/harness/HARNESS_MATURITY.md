...
- `docs/harness/HARNESS.md`, `docs/harness/FEATURE_INTAKE.md`, and `docs/harness/GENERIC_ARCHITECTURE_TEMPLATE.md`
  exist.
- Story, decision, and validation templates exist under `docs/templates/`.
- `docs/harness/TEST_MATRIX.md` defines proof columns and status meanings.
...
- Partially achieved by Phase 5. `scripts/bin/harness-cli audit` detects
  ...
  `docs/harness/IMPROVEMENT_PROTOCOL.md` defines the review loop. H5 is not fully
...
| H1 | Achieved | `AGENTS.md`, `docs/harness/HARNESS.md`, `docs/harness/FEATURE_INTAKE.md`, `docs/harness/GENERIC_ARCHITECTURE_TEMPLATE.md`, `docs/templates/*`, and `docs/harness/TEST_MATRIX.md` exist. |
...
| H5 | Partial | Phase 5 adds `audit`, `score-context`, `intervention add/query`, `propose`, `docs/harness/HARNESS_AUDIT.md`, and `docs/harness/IMPROVEMENT_PROTOCOL.md`; repeated benchmark outcome proof remains open. |
